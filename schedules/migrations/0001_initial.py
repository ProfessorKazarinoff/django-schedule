    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('crn', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='schedules.crn')),
                ('instructor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='schedules.instructor')),
            ],
        ),
    ]
